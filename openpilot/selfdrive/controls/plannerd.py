...
def main():
  ...
  ignore_services = ["liveMapDataSP", "carStateSP", "selfdriveStateSP", "lateralTorqueParameters", gps_location_service]
  ...
  sm = messaging.SubMaster(['carControl', 'carState', 'controlsState', 'vehicleParameters', 'radarState', 'modelV2', 'selfdriveState',
                            'liveMapDataSP', 'carStateSP', 'selfdriveStateSP', 'lateralTorqueParameters', gps_location_service],
