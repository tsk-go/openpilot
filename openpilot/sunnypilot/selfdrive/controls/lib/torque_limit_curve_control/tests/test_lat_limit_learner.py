...
class TestLateralLimitLearner(unittest.TestCase):
  def test_prior_from_torque_params(self):
    learner = LateralLimitLearner(make_cp(), FakeParams())
  ...
  def test_prior_for_angle_cars(self):
    learner = LateralLimitLearner(make_cp(torque=False), FakeParams())
  ...
  def test_cache_round_trip(self):
    params = FakeParams()
    learner = LateralLimitLearner(make_cp(), params)
    ...
    fresh = LateralLimitLearner(make_cp(), params)
